...
<div class="container-fluid">
  ...
  <div class="col-xs-10">
    ...
    <div class="col-xs-2"><a href="index_admin.php"><button type="submit" class="btn btn-primary">Admin view</button></a></div>
...
<div class="container">
<button style=" background-color:#4169E1;  color: #ffffff;"  class = "col-xs-12 collapsible" name= "toggle1" id= "toggle1" onclick="myFunction1()"><h4><b>Personal details open</b></h4></button>
<div class = "content">
