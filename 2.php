...
<div class="container">
<button style="width: 100%"  class = "collapsibl" name= "togglea" id= "togglea" onclick="myFunctiona()"><h4><b>Academic report Open</b></h4></button>
<div class = "conten">
...
<div id="gauge">
  ...
  <strong>
        ...
        <h5> <input type="text" name="miles" class="form-control col-lg-2" maxlength="2" id="miles" value="<?php echo "{$JFC}"; ?>"> </h5>
                   <h5 align="left">  Description : You are  <?php echo "{$JFC}"; ?>% suitable to the industry <br> with
