...
<div class="wrapper">
  ...
  <li class="nav-item">
      ...
      <li class="nav-item">
          <h2 style="color: white; vertical-align: bottom; font-size: 25px; font-family: candara" align="right" >
            <strong>Welcome <br>
              <?php  echo $row['F_Name']; ?><br></strong></h2>
...
<div id="gauge">
  ...
  <strong>
                    ...
                    <h5> <input type="text" name="miles" class="form-control col-lg-2" maxlength="2" id="miles" value="0"> </h5>
                   <h5 align="left">  Description : You are  % suitable to the industry <br> with
              ...
              <div class="card-body p-0">
                <div class="table-responsive">
                  <table class="table m-0">
                    ...
                    <tbody>
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="10/06/2019"></td>
...
<?php  if($c==1) { ?>
                   <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="20/07/2019"></td>
...
<?php if($c==2) { ?>
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="18/07/2019"></td>
...
<?php if($c==4) { ?>      
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="31/07/2019"></td>
...
<?php if($c==6) { ?>                    
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="3/08/2019"></td>
...
<?php if($c==7) { ?>                   
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="10/08/2019"></td>
...
<?php if($c==8) { ?>                    
                    ...
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="15/08/2019"></td>
...
<?php if($c==9) { ?>
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="23/07/2019"></td>
...
<?php if($c==10) { ?>                    
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="20/08/2019"></td>
...
<?php if($c==11) { ?>
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="25/08/2019"></td>
...
<?php if($c==12) { ?>
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="31/08/2019"></td>
...
<?php if($c==13) { ?>
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="4/09/2019"></td>
...
<?php } ?>                    
                  ...
                  ?>
                    ...
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="11/09/2019"></td>
...
<?php  if($c2==1) { ?>
                    ...
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="21/09/2019"></td>
...
<?php  if($c2==2) { ?>
                    ...
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="25/09/2019"></td>
...
<?php  if($c2==3) { ?>
                    ...
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="30/09/2019"></td>
...
<?php  if($c2==4) { ?>
                    ...
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="5/10/2019"></td>
...
<?php  if($c2==5) { ?>
                    ...
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="9/10/2019"></td>
...
<?php  if($c2==6) { ?>
                    ...
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="16/10/2019"></td>
...
<?php  if($c2==7) { ?>
                    ...
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="24/10/2019"></td>
...
<?php  if($c2==8) { ?>
                    ...
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="30/10/2019"></td>
...
<?php  if($c2==9) { ?>
                    ...
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="2/11/2019"></td>
...
<?php  if($c2==10) { ?>
                    ...
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="9/11/2019"></td>
...
<?php  if($c2==11) { ?>
                    ...
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="18/11/2019"></td>
...
<?php  if($c2==12) { ?>
                    ...
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="24/11/2019"></td>
...
<?php $c2=$c2+1; } ?>
                    ...
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="30/11/2019"></td>
...
<?php  if($c3==1) { ?>              
                    ...
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="2/12/2019"></td>
...
<?php  if($c3==2) { ?>     
                    ...
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="5/12/2019"></td>
...
<?php  if($c3==3) { ?>     
                    ...
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="12/12/2019"></td>
...
<?php  if($c3==4) { ?>     
                    ...
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="19/12/2019"></td>
...
<?php  if($c3==5) { ?>     
                    ...
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="26/12/2019"></td>
...
<?php  if($c3==6) { ?>     
                    ...
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="30/12/2019"></td>
...
<?php  if($c3==7) { ?>     
                    ...
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="2/01/2020"></td>
...
<?php  if($c3==8) { ?>     
                    ...
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="7/01/2020"></td>
...
<?php  if($c3==9) { ?>     
                    ...
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="10/01/2020"></td>
...
<?php  if($c3==10) { ?>     
                    ...
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="12/01/2020"></td>
...
<?php  if($c3==11) { ?>     
                    ...
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="14/01/2020"></td>
...
<?php  if($c3==12) { ?>     
                    ...
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="17/01/2020"></td>
...
<?php $c3=$c3+1; } ?>     
                    ...
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="18/01/2020"></td>
...
<?php  if($c4==1) { ?>
                    ...
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="20/01/2020"></td>
...
<?php  if($c4==2) { ?>
                    ...
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="23/01/2020"></td>
...
<?php  if($c4==3) { ?>
                    ...
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="25/01/2020"></td>
...
<?php  if($c4==4) { ?>
                    ...
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="27/01/2020"></td>
...
<?php  if($c4==5) { ?>
                    ...
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="1/02/2020"></td>
...
<?php  if($c4==7) { ?>
                    ...
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="3/02/2020"></td>
...
<?php  if($c4==8) { ?>
                    ...
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="5/02/2020"></td>
...
<?php  if($c4==9) { ?>
                    ...
                    <tr>
                      <td><input type="text" name="id" size="6" class="form-control col-lg-8" placeholder="Tenth marks" value="9/02/2020"></td>
