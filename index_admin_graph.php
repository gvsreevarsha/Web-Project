...
$dataPoints = array(
  ...
  array("label"=> "Core 6", "y"=> 50),
  array("label"=> "Core 7", "y"=> 50),
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h3><input type="text" name="id" size="2" placeholder="Tenth marks" style="color:black" value="<?php 
          ...
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                <h3><input type="text" name="id" size="2" placeholder="Inter marks" style="color:black" value="<?php 
          ...
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
                <h3>
                  <input type="text" name="id" placeholder="B.tech marks" size="3" style="color:black" 
...
zingchart.render({ 
	...
	width: "100%"
                    ...
                    You are
                    <input type="text" name="id" size="1" placeholder="Tenth marks" style="color:black" 
                    value="<?php echo "{$JFC}"; ?>"> % suitable <br/>to the industry with
